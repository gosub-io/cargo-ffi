...
impl Default for TabCookieJar { fn default() -> Self { Self::Inherit } }
...
impl Default for TabStorageScope { fn default() -> Self { Self::Inherit } }


#[derive(Clone, Debug)]
pub enum TabCacheMode { Inherit, Default, Bypass, Ephemeral }
impl Default for TabCacheMode { fn default() -> Self { Self::Inherit } }